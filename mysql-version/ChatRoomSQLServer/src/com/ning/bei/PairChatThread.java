...
public class PairChatThread extends Thread {
	...
	public PairChatThread(Credentials newUserIn, Connection connIn, UserList allUserIn, OnlineUserList onlineUserIn,
			String nicknameIn) {
		newUser = newUserIn;
		conn = connIn;
		allUsers = allUserIn;
			...
			while (!(Thread.currentThread().interrupted())) {
				if (flag) {
					if (inputLine.startsWith("#PU")) {
						...
						System.out.println(now.toString() + ", " + newUser.getUsername() + " to " + target + " : "
						...
						outMe.println("#PMESSAGE" + now.toString() + "   " + nickname + " : " + inputLine.substring(9));
