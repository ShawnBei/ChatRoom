...
public class GroupChatThread extends Thread {
	...
	public GroupChatThread(Credentials newUserIn, Connection connIn, UserList allUserIn, OnlineUserList onlineUserIn, String nicknameIn) {
		newUser = newUserIn;
		conn = connIn;
		allUsers = allUserIn;
			...
			while (!(Thread.currentThread().interrupted())) {
				if (flag) {
					if (inputLine.startsWith("#GMESSAGE")) {
						...
						System.out.println(now.toString() + " " + newUser.getUsername() + "(" + nickname + ")" + " : " + inputLine);
